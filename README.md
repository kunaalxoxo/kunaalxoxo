...
2nd-year undergrad (GPA 7.84) from BITS Pilani Hyderabad, India, building CRM workflows and chasing AI engineering.

## What I Do
- CRM developer customizing Zoho with Deluge scripting, workflows, and task automation
- Full-stack skills in JavaScript, Python, C++; completed AI (DeepLearning.AI) and Git/GitHub (IBM) courses
- Microsoft Explore Program applicant and GSoC 2026 hopeful for open-source impact
